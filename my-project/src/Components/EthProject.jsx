...
const EthProject = () => {
    ...
    <div className="relative text-white flex flex-row lg:flex-col space-y-5 mt-5">
        ...
        <p> Within this project, I have developed a voting system using Solidity smart contracts on the Ethereum
            ...
            accessibility,
            trust and participation levels. I have simplified interactions with the smart contract through
            accessible
            means and powered by industry leading frameworks such as ``Web3.js''. The website I built as the
            frontend is used throughout the whole process, from registering to vote, casting their vote and
            viewing the election results.</p>
    </div>
)
}

export default EthProject;